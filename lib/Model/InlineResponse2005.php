...
class InlineResponse2005 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['adress_id'] = isset($data['adress_id']) ? $data['adress_id'] : null;
    }
    ...
    {
        return $this->container['adress_id'];
    }

    /**
     * Sets adress_id
     *
     * @param int $adress_id L'id de l'adresse, à sauvegarder en local pour plus de confort
     *
     * @return $this
     */
    public function setAdressId($adress_id)
    {
        $this->container['adress_id'] = $adress_id;
