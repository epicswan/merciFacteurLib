...
class InlineResponse2008 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['nb_files'] = isset($data['nb_files']) ? $data['nb_files'] : null;
    }
     ...
     * Sets token
     *
     * @param string $token Le token contenant le fichier envoyé (et les éventuels autres fichiers)
     *
     * @return $this
     */
     ...
     * Sets nb_files
     *
     * @param string $nb_files Le nombre de fichiers contenus dans ce token
     *
     * @return $this
     */
