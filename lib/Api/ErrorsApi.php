...
class ErrorsApi
{
     ...
     * @return \MerciFacteurApi\Client\Model\InlineResponse20020
     */
    public function listErrors($ww_service_id, $ww_access_token)
    {
        list($response) = $this->listErrorsWithHttpInfo($ww_service_id, $ww_access_token);
        return $response;
    }
     ...
     * @throws \MerciFacteurApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MerciFacteurApi\Client\Model\InlineResponse20020, HTTP status code, HTTP response headers (array of strings)
     */
    public function listErrorsWithHttpInfo($ww_service_id, $ww_access_token)
    {
        $returnType = '\MerciFacteurApi\Client\Model\InlineResponse20020';
        $request = $this->listErrorsRequest($ww_service_id, $ww_access_token);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MerciFacteurApi\Client\Model\InlineResponse20020',
     ...
     */
    public function listErrorsAsync($ww_service_id, $ww_access_token)
    {
        return $this->listErrorsAsyncWithHttpInfo($ww_service_id, $ww_access_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listErrorsAsyncWithHttpInfo($ww_service_id, $ww_access_token)
    {
        $returnType = '\MerciFacteurApi\Client\Model\InlineResponse20020';
        $request = $this->listErrorsRequest($ww_service_id, $ww_access_token);
     ...
     */
    protected function listErrorsRequest($ww_service_id, $ww_access_token)
    {
        ...
        if ($ww_service_id === null || (is_array($ww_service_id) && count($ww_service_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ww_service_id when calling listErrors'
            );
        }
        ...
        if ($ww_access_token === null || (is_array($ww_access_token) && count($ww_access_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ww_access_token when calling listErrors'
            );
        }

        $resourcePath = '/listErrors';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
