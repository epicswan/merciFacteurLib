...
import {InlineResponse20020ListErrors} from './InlineResponse20020ListErrors';
...
export class InlineResponse20020 {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('listErrors'))
        obj.listErrors = InlineResponse20020ListErrors.constructFromObject(data['listErrors']);
    }
    return obj;
  }
}
 ...
 * @member {String} error
 */
InlineResponse20020.prototype.error = undefined;

/**
 * @member {module:model/InlineResponse20020ListErrors} listErrors
 */
InlineResponse20020.prototype.listErrors = undefined;
