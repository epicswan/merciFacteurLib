...
export class InlineResponse2008 {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nbFiles'))
        obj.nbFiles = ApiClient.convertToType(data['nbFiles'], 'String');
    }
    return obj;
  }
}
 ...
 * @member {String} nbFiles
 */
InlineResponse2008.prototype.nbFiles = undefined;
