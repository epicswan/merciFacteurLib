...
import {InlineResponse2006Adress} from './InlineResponse2006Adress';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('adress'))
        obj.adress = ApiClient.convertToType(data['adress'], [InlineResponse2006Adress]);
    }
    return obj;
  }
}
 ...
 * @member {String} error
 */
InlineResponse2006.prototype.error = undefined;

/**
 * @member {Array.<module:model/InlineResponse2006Adress>} adress
 */
InlineResponse2006.prototype.adress = undefined;
