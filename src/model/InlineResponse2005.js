...
export class InlineResponse2005 {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('adress_id'))
        obj.adressId = ApiClient.convertToType(data['adress_id'], 'Number');
    }
    return obj;
  }
}
 ...
 * @member {String} error
 */
InlineResponse2005.prototype.error = undefined;

/**
 * L'id de l'adresse, à sauvegarder en local pour plus de confort
 * @member {Number} adressId
 */
InlineResponse2005.prototype.adressId = undefined;
