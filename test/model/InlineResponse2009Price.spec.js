...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2009Price', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.InlineResponse2009Price();
      });

      it('should create an instance of InlineResponse2009Price', function() {
        // TODO: update the code to test InlineResponse2009Price
        expect(instance).to.be.a(MerciFacteurApi.InlineResponse2009Price);
      });
