...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2005', function() {
      ...
      it('should have the property adressId (base name: "adress_id")', function() {
        // TODO: update the code to test the property adressId
        expect(instance).to.have.property('adressId');
        // expect(instance.adressId).to.be(expectedValueLiteral);
      });
