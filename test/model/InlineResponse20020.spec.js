...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20020', function() {
      ...
      it('should have the property listErrors (base name: "listErrors")', function() {
        // TODO: update the code to test the property listErrors
        expect(instance).to.have.property('listErrors');
        // expect(instance.listErrors).to.be(expectedValueLiteral);
      });
