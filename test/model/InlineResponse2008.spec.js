...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2008', function() {
      ...
      it('should have the property nbFiles (base name: "nbFiles")', function() {
        // TODO: update the code to test the property nbFiles
        expect(instance).to.have.property('nbFiles');
        // expect(instance.nbFiles).to.be(expectedValueLiteral);
      });
