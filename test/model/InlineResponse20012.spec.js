...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20012', function() {
      ...
      it('should have the property envoi (base name: "envoi")', function() {
        // TODO: update the code to test the property envoi
        expect(instance).to.have.property('envoi');
        // expect(instance.envoi).to.be(expectedValueLiteral);
      });
