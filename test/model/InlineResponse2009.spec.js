...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2009', function() {
      ...
      it('should have the property envoiId (base name: "envoi_id")', function() {
        // TODO: update the code to test the property envoiId
        expect(instance).to.have.property('envoiId');
        // expect(instance.envoiId).to.be(expectedValueLiteral);
      });
