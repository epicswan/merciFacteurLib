...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20014', function() {
      ...
      it('should have the property sourceValidation (base name: "sourceValidation")', function() {
        // TODO: update the code to test the property sourceValidation
        expect(instance).to.have.property('sourceValidation');
        // expect(instance.sourceValidation).to.be(expectedValueLiteral);
      });
