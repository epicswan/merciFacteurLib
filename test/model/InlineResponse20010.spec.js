...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20010', function() {
      ...
      it('should have the property poids (base name: "poids")', function() {
        // TODO: update the code to test the property poids
        expect(instance).to.have.property('poids');
        // expect(instance.poids).to.be(expectedValueLiteral);
      });
