...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendCourrierAnonymize', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.SendCourrierAnonymize();
      });

      it('should create an instance of SendCourrierAnonymize', function() {
        // TODO: update the code to test SendCourrierAnonymize
        expect(instance).to.be.a(MerciFacteurApi.SendCourrierAnonymize);
      });
