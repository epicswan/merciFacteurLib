...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20011', function() {
      ...
      it('should have the property envois (base name: "envois")', function() {
        // TODO: update the code to test the property envois
        expect(instance).to.have.property('envois');
        // expect(instance.envois).to.be(expectedValueLiteral);
      });
