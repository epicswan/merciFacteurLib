...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20018Quotas', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.InlineResponse20018Quotas();
      });

      it('should create an instance of InlineResponse20018Quotas', function() {
        // TODO: update the code to test InlineResponse20018Quotas
        expect(instance).to.be.a(MerciFacteurApi.InlineResponse20018Quotas);
      });
