...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20012Envoi', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.InlineResponse20012Envoi();
      });

      it('should create an instance of InlineResponse20012Envoi', function() {
        // TODO: update the code to test InlineResponse20012Envoi
        expect(instance).to.be.a(MerciFacteurApi.InlineResponse20012Envoi);
      });
