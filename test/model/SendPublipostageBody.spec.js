...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendPublipostageBody', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.SendPublipostageBody();
      });

      it('should create an instance of SendPublipostageBody', function() {
        // TODO: update the code to test SendPublipostageBody
        expect(instance).to.be.a(MerciFacteurApi.SendPublipostageBody);
      });
      ...
      it('should have the property jsonExp (base name: "jsonExp")', function() {
        // TODO: update the code to test the property jsonExp
        expect(instance).to.have.property('jsonExp');
        // expect(instance.jsonExp).to.be(expectedValueLiteral);
      });
