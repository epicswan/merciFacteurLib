  ...
  describe('(package)', function() {
    describe('InlineResponse20018', function() {
      ...
      it('should have the property quotas (base name: "quotas")', function() {
        // TODO: update the code to test the property quotas
        expect(instance).to.have.property('quotas');
        // expect(instance.quotas).to.be(expectedValueLiteral);
      });
