...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20013TemplateValidation', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.InlineResponse20013TemplateValidation();
      });

      it('should create an instance of InlineResponse20013TemplateValidation', function() {
        // TODO: update the code to test InlineResponse20013TemplateValidation
        expect(instance).to.be.a(MerciFacteurApi.InlineResponse20013TemplateValidation);
      });

      it('should have the property timeTemplate (base name: "timeTemplate")', function() {
        // TODO: update the code to test the property timeTemplate
        expect(instance).to.have.property('timeTemplate');
        // expect(instance.timeTemplate).to.be(expectedValueLiteral);
      });
