...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdressSendCourrier', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.AdressSendCourrier();
      });

      it('should create an instance of AdressSendCourrier', function() {
        // TODO: update the code to test AdressSendCourrier
        expect(instance).to.be.a(MerciFacteurApi.AdressSendCourrier);
      });
