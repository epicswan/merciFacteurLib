...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdressInfosAdress', function() {
      beforeEach(function() {
        instance = new MerciFacteurApi.AdressInfosAdress();
      });

      it('should create an instance of AdressInfosAdress', function() {
        // TODO: update the code to test AdressInfosAdress
        expect(instance).to.be.a(MerciFacteurApi.AdressInfosAdress);
      });
      ...
      it('should have the property consent (base name: "consent")', function() {
        // TODO: update the code to test the property consent
        expect(instance).to.have.property('consent');
        // expect(instance.consent).to.be(expectedValueLiteral);
      });
