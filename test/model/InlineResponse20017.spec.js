...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20017', function() {
      ...
      it('should have the property formatReturn (base name: "format_return")', function() {
        // TODO: update the code to test the property formatReturn
        expect(instance).to.have.property('formatReturn');
        // expect(instance.formatReturn).to.be(expectedValueLiteral);
      });
